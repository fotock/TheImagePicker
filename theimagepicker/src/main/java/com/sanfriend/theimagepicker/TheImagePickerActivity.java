package com.sanfriend.theimagepicker;
...
import com.sanfriend.theimagepicker.model.Image;
import com.sanfriend.theimagepicker.utils.ImageInternalFetcher;

public class TheImagePickerActivity extends Activity implements ActionBar.TabListener {

    private static final String TAG = TheImagePickerActivity.class.getSimpleName();

    /**
     * Key to persist the list when saving the state of the activity.
     */
    private static final String KEY_LIST = "com.sanfriend.theimagepicker.savedinstance.key.list";

    /**
     * Returns the parcelled image uris in the intent with this extra.
     */
    public static final String EXTRA_IMAGE_URIS = "com.sanfriend.theimagepicker.extra.selected_image_uris";

    /**
     * Integer extra to limit the number of images that can be selected. By default the user can
     * select infinite number of images.
     */
    public static final String EXTRA_SELECTION_LIMIT = "com.sanfriend.theimagepicker.extra.selection_limit";
    ...
    public boolean addImage(Image image) {
        ...
        if (mSelectedImages.size() == mMaxSelectionsAllowed) {
            ...
            if (mSelectedImages.add(image)) {
                View rootView = LayoutInflater.from(TheImagePickerActivity.this).inflate(R.layout.list_item_selected_thumbnail, null);
